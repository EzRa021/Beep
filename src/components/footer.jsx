...
const Footer = () => {
  return (
    <div><footer className="footer footer--dark">
    <div className="footer__top">
        <div className="container">
            <div className="row">
                <div className="col-xl-3">
                    <div className="footer__brand-logo flex items-center">
                        <img src="/assets/css/shopping-online.png" className='h-6 mr-3 sm:h-9' alt="logo-brand" />
                        <span class="self-center text-xl font-semibold whitespace-nowrap text-white">Beep</span>
                    </div>
                    <div className="footer__loc-info">
                        <p className="text--body-3">
                            University of Ibadan
                        </p>
                        <p className="text--body-3 phone">
                            Phone: +234 701 222 9660
                        </p>
                        <p className="text--body-3 email">
                            Mail: beep@gmail.com
                        </p>
                    </div>
                </div>
                <div className="col-xl-2 col-lg-2 col-sm-4 col-6">
                    <h2 className="footer__title text--body-2-600">Supports</h2>

                    <ul className="footer-menu">
                        <li className="footer-menu__item">
                            <a href="contact.html" className="footer-menu__link text--body-3">Contact</a>
                        </li>
                        <li className="footer-menu__item">
                            <a href="price-plan.html" className="footer-menu__link text--body-3">Pricing Plans</a>
                        </li>
                        <li className="footer-menu__item">
                            <a href="sitemap.html" className="footer-menu__link text--body-3">Sitemap</a>
                        </li>
                    </ul>
                </div>
                <div className="col-xl-2 col-lg-2 col-sm-4 col-6">
                    <h2 className="footer__title text--body-2-600">Quick Links</h2>

                    <ul className="footer-menu">
                        <li className="footer-menu__item">
                            <a href="about.html" className="footer-menu__link text--body-3">About</a>
                        </li>
                        <li className="footer-menu__item">
                            <a href="get-membership.html" className="footer-menu__link text--body-3">Get Membership</a>
                        </li>
                        <li className="footer-menu__item">
                            <a href="blog-list.html" className="footer-menu__link text--body-3">Blog</a>
                        </li>
                    </ul>
                </div>
                <div className="col-xl-2 col-lg-2 col-sm-4 col-6">
                    <h2 className="footer__title text--body-2-600">Category</h2>

                    <ul className="footer-menu">
                        <li className="footer-menu__item">
                            <a href="#" className="footer-menu__link text--body-3">Mobile</a>
                        </li>
                        <li className="footer-menu__item">
                            <a href="#" className="footer-menu__link text--body-3">Electronics</a>
                        </li>
                        <li className="footer-menu__item">
                            <a href="#" className="footer-menu__link text--body-3">Vehicles</a>
                        </li>
                    </ul>
                </div>
                <div className="col-xl-4 col-lg-6">
                    <h2 className="footer__title text--body-2-600">Download our app</h2>
                    ...
                    <ul className="social-icon">
                        ...
                        {/* <!-- Twitter --> */}
                        <li className="social-icon__item">
                            <a href="www.x.com/beep" className="social-icon__link">
                                <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path
                        ...
                        {/* <!-- Youtube --> */}
                        <li className="social-icon__item">
                            <a href="www.youtube.com/channels/beep" className="social-icon__link">
                                <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path
                        ...
                        {/* <!-- Linked in --> */}
                        <li className="social-icon__item">
                            <a href="www.linkedln.com/beepmarketplace" className="social-icon__link">
                                <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="container">
            <div className="row footer__copyright">
                <div className="col-md-6">
                    <p className="text--body-3">Beep - Online Marketplace © 2024. Design by Olaoluwa Olawale Taiwo</p>
                </div>
                <div className="col-md-6">
                    <div className="footer__policy-condition">
                        <a href="" className="text--body-3">Privacy Policy</a> |
                        <a href="" className="text--body-3">Terms &amp; Conditions</a>
                    </div>
                </div>
            </div>
        </div>
