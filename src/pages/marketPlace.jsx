            ...
            <div className="container">
                ...
                <div className="row">
                    <div className="col-xl-3 col-md-6">
                        <div className="cards cards--one cards--highlight">
                            <a href="ad-details.html" className="cards__img-wrapper">
                                <img src="/src/images/view/img-51.png" alt="card-img" className="img-fluid" />
                            </a>
                            <div className="cards__info">
                                <div className="cards__info-top">
                                    ...
                                    <a href="#" className="text--body-3-600 cards__caption-title"><b> My name is Stella, i'm an eventplanner and i trained.  </b> </a>
                                </div>
                    ...
                    <div className="col-xl-3 col-md-6">
                        <div className="cards cards--one">
                            <a href="ad-details.html" className="cards__img-wrapper">
                                <img src="/src/images/view/img-47.png" alt="card-img" className="img-fluid" />
                            </a>
                            <div className="cards__info">
                                <div className="cards__info-top">
                                    <h6 className="text--body-4 cards__category-title">
                                    ...
                                    <a href="ad-details.html" className="text--body-3-600 cards__caption-title"><b>My name is David, I'm a freelancer</b> </a>
                                </div>
                                <div className="cards__info-bottom">
                                    <h6 className="cards__location text--body-4">
                                        <span className="icon">
                        ...
                        <div className="cards cards--one">
                            ...
                            <div className="cards__info">
                                <div className="cards__info-top">
                                    ...
                                    <a href="ad-details.html" className="text--body-3-600 cards__caption-title"><b> Neat Chair and Table for sale DM for price</b></a>
                                </div>
                                <div className="cards__info-bottom">
                                    <h6 className="cards__location text--body-4">
                                        <span className="icon">
                        ...
                        <div className="cards cards--one cards--highlight">
                            ...
                            <div className="cards__info">
                                <div className="cards__info-top">
                                    ...
                                    <a href="ad-details.html" className="text--body-3-600 cards__caption-title"><b>I'm a mobile barber</b></a>
                                </div>
                                <div className="cards__info-bottom">
                                    <h6 className="cards__location text--body-4">
                                        <span className="icon">
                    ...
                    <div className="col-xl-3 col-md-6">
                        <div className="cards cards--one">
                            <a href="ad-details.html" className="cards__img-wrapper">
                                <img src="/src/images/view/img-48.png" alt="card-img" className="img-fluid" />
                            </a>
                            <div className="cards__info">
                                <div className="cards__info-top">
                                    <h6 className="text--body-4 cards__category-title">
                                    ...
                                    <a href="ad-details.html" className="text--body-3-600 cards__caption-title"><b> Dina Signatures and Logistics...serving you better.</b></a>
                                </div>
                                <div className="cards__info-bottom">
                                    <h6 className="cards__location text--body-4">
                                        <span className="icon">
                    ...
                    <div className="col-xl-3 col-md-6">
                        <div className="cards cards--one">
                            <a href="ad-details.html" className="cards__img-wrapper">
                                <img src="/src/images/view/img-58.png" alt="card-img" className="img-fluid" />
                            </a>
                            <div className="cards__info">
                                <div className="cards__info-top">
                                    <h6 className="text--body-4 cards__category-title">
                                    ...
                                    <a href="ad-details.html" className="text--body-3-600 cards__caption-title"><b> Olaide Coutre: clothe and wear brand.</b></a>
                                </div>
                                <div className="cards__info-bottom">
                                    <h6 className="cards__location text--body-4">
                                        <span className="icon">
                    ...
                    <div className="col-xl-3 col-md-6">
                        <div className="cards cards--one">
                            <a href="ad-details.html" className="cards__img-wrapper">
                                <img src="/src/images/view/img-39.png" alt="card-img" className="img-fluid" />
                            </a>
                            <div className="cards__info">
                                <div className="cards__info-top">
                                    <h6 className="text--body-4 cards__category-title">
                                    ...
                                    <a href="ad-details.html" className="text--body-3-600 cards__caption-title"><b>Mushy Bakes & Cakes</b></a>
                                </div>
                                <div className="cards__info-bottom">
                                    <h6 className="cards__location text--body-4">
                                        <span className="icon">
                    ...
                    <div className="col-xl-3 col-md-6">
                        <div className="cards cards--one cards--highlight">
                            <a href="ad-details.html" className="cards__img-wrapper">
                                <img src="/src/images/view/img-52.png" alt="card-img" className="img-fluid" />
                            </a>
                            <div className="cards__info">
                                <div className="cards__info-top">
                                    <h6 className="text--body-4 cards__category-title">
                                    ...
                                    <a href="ad-details.html" className="text--body-3-600 cards__caption-title"><b> Fitness and Gym center</b></a>
                                </div>
                                <div className="cards__info-bottom">
                                    <h6 className="cards__location text--body-4">
                                        <span className="icon">
                        ...
                        <div className="cards cards--one">
                            ...
                            <div className="cards__info">
                                <div className="cards__info-top">
                                    ...
                                    <a href="ad-details.html" className="text--body-3-600 cards__caption-title"><b>Student Mattress for sale DM for price.</b></a>
                                </div>
                                <div className="cards__info-bottom">
                                    <h6 className="cards__location text--body-4">
                                        <span className="icon">
                        ...
                        <div className="cards cards--one">
                            ...
                            <div className="cards__info">
                                <div className="cards__info-top">
                                    ...
                                    <a href="ad-details.html" className="text--body-3-600 cards__caption-title"><b> Tasty snacks and sweets availabe</b></a>
                                </div>
                                <div className="cards__info-bottom">
                                    <h6 className="cards__location text--body-4">
                                        <span className="icon">
                    ...
                    <div className="col-xl-3 col-md-6">
                        <div className="cards cards--one">
                            <a href="ad-details.html" className="cards__img-wrapper">
                                <img src="/src/images/view/img-45.png" alt="card-img" className="img-fluid" />
                            </a>
                            <div className="cards__info">
                                <div className="cards__info-top">
                                    <h6 className="text--body-4 cards__category-title">
                                    ...
                                    <a href="ad-details.html" className="text--body-3-600 cards__caption-title">SH cleaning and home services</a>
                                </div>
                                <div className="cards__info-bottom">
                                    <h6 className="cards__location text--body-4">
                                        <span className="icon">
