...
const AdDetails = () => {
  return (
    <div>
                ...
                <div className="row">
                    <div className="col-xl-8">
                        ...
                        <div className="product-item__ads-info">
                            <h2 className="text--heading-2 title">itel A70 @ Idia Hall (Used)</h2>
                            ...
                            <ul className="post-details">
                                <li className="post-details__item">
                                    ...
                                    <p className="text--body-3">india hall University of Ibadan</p>
                                </li>
                                <li className="post-details__item">
                                    <span className="icon">
                                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <p className="text--body-3">29 Jun 10:21 PM</p>
                                </li>
                                <li className="post-details__item">
                                    <span className="icon">
                                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <p className="text--body-3">69,656 Viewed</p>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div className="product-item__gallery">
                            <div className="product-item__slider-content-top">
                                <div className="product-item__slider product-slider-for">
                                    <div className="product-item__slider-item">
                                        <img src="/src/images/slider/img-lg-01.png" alt="product-img" />
                                    </div>
                                    <div className="product-item__slider-item">
                                        <img src="/src/images/slider/img-lg-02.png" alt="product-img" />
                                    </div>
                                    <div className="product-item__slider-item">
                                        <img src="/src/images/slider/img-lg-03.png" alt="product-img" />
                                    </div>
                                    <div className="product-item__slider-item">
                                        <img src="/src/images/slider/img-lg-04.png" alt="product-img" />
                                    </div>
                                    <div className="product-item__slider-item">
                                        <img src="/src/images/slider/img-lg-05.png" alt="product-img" />
                                    </div>
                                    <div className="product-item__slider-item">
                                        <img src="/src/images/slider/img-lg-06.png" alt="product-img" />
                                    </div>
                                    <div className="product-item__slider-item">
                                        <img src="/src/images/slider/img-lg-01.png" alt="product-img" />
                                    </div>
                                ...
                                <div className="view">
                                    <a className="icon" href="full-page.html">
                                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div className="product-item__slider-content-bottom">
                                <div className="product-slider-nav">
                                    <div className="product-slider-nav__item">
                                        <img src="/src/images/slider/img-lg-01.png" alt=" product-sm" />
                                    </div>
                                    <div className="product-slider-nav__item">
                                        <img src="/src/images/slider/img-lg-02.png" alt=" product-sm" />
                                    </div>
                                    <div className="product-slider-nav__item">
                                        <img src="/src/images/slider/img-lg-03.png" alt=" product-sm" />
                                    </div>
                                    <div className="product-slider-nav__item">
                                        <img src="/src/images/slider/img-lg-04.png" alt=" product-sm" />
                                    </div>
                                    <div className="product-slider-nav__item">
                                        <img src="/src/images/slider/img-lg-05.png" alt=" product-sm" />
                                    </div>
                                    <div className="product-slider-nav__item">
                                        <img src="/src/images/slider/img-lg-06.png" alt=" product-sm" />
                                    </div>
                                    <div className="product-slider-nav__item">
                                        <img src="/src/images/slider/img-lg-01.png" alt=" product-sm" />
                                    </div>
                        ...
                        <div className="product-item__description">
                            ...
                            <p className="text--body-3">
                               Selling my itel A70 phone! it's in excellent conditions with a sleek design, vibrant display and long-lasting battery life. perfect for everyday use for multi-tasking. Don't miss this great deal! 
                            </p>
                            <p className="text--body-3">
                                ...
                                <li>
                                    <ul>
                                        <li className="feature-item">
                                            ...
                                            <p className="text--body-3">128GB internal memory with 8GB RAM</p>
                                        </li>
                                        <li className="feature-item">
                                            <span className="icon">
                                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            <p className="text--body-3">LED flash, HDR, panorama</p>
                                        </li>
                                        <li className="feature-item">
                                            <span className="icon">
                                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <li className="feature-item">
                                            ...
                                            <p className="text--body-3">Li-Po 4000 mAh, non-removable battery</p>
                                        </li>
                                    </ul>
                                </li>
                                <li>
                                    <ul>
                                        <li className="feature-item">
                                            ...
                                            <p className="text--body-3">Android 9, Funtouch 11.1 Operating System</p>
                                        </li>
                                        <li className="feature-item">
                                            <span className="icon">
                                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            <p className="text--body-3">Fast charging 33W, 63% 1hr (advertised)</p>
                                        </li>
                                        <li className="feature-item">
                                            <span className="icon">
                                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            <p className="text--body-3">Glass front, plastic frame, plastic back</p>
                                        </li>
                                        <li className="feature-item">
                                            <span className="icon">
                                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className="col-xl-4">
                        <div className="product-item__sidebar">
                            <div className="product-item__sidebar-top">
                                <div className="product-item__sidebar-item product-price">
                                    <h2 className="text--heading-2">#42,000</h2>
                                ...
                                <div className="product-item__sidebar-item">
                                    <div className="card-number">
                                        ...
                                        <span className="text--body-4 message">Phone number revealed.</span>
                                    </div>
                                ...
                                <div className="product-item__sidebar-item user-details">
                                    <div className="user">
                                        ...
                                        <div className="info">
                                            ...
                                            <h2 className="text--body-3-600">Taiwo Olaoluwa</h2>
                                        </div>
                                    </div>
                                    <ul className="contact">
                                        <li className="contact-item">
                                            ...
                                            <h6 className="text--body-3">TaiwoOlaoluwa@gmail.com</h6>
                                        </li>
                                        <li className="contact-item">
                                            <span className="icon">
                                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            <h6 className="text--body-3">Idia Hall University of Ibadan</h6>
                                        </li>
                                        <li className="contact-item">
                                            <span className="icon">
                                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div className="product-item__sidebar-item location">
                                    <h2 className="text--body-2">Ads location</h2>
                            ...
                            <div className="product-item__sidebar-bottom">
                                <div className="product-item__sidebar-item overview">
                                    <h2 className="text--body-1">Overview</h2>
                                    <ul className="overview-details">
                                        <li className="overview-details__item">
                                            <span className="text--body-3 title">Conditions:</span>
                                            <span className="text--body-3 info">Used</span>
                                        </li>
                                        <li className="overview-details__item">
                                            <span className="text--body-3 title">brand:</span>
                                            <span className="text--body-3 info">Itel</span>
                                        </li>
                                        <li className="overview-details__item">
                                            <span className="text--body-3 title">Model:</span>
                                            <span className="text--body-3 info">A70</span>
                                        </li>
                                        <li className="overview-details__item">
                                            <span className="text--body-3 title">Model Year:</span>
                                            <span className="text--body-3 info">2021</span>
                                        </li>
                                        <li className="overview-details__item">
                                            <span className="text--body-3 title">Authenticity:</span>
                                            <span className="text--body-3 info">Orginal</span>
                                        </li>
                                    </ul>
                                    ...
                                    <div className="share-content">
                                        <h2 className="share-content__title text--body-3">
                                            <span className="icon">
                                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path
                                        ...
                                        <ul className="share">
                                            <li className="share__item">
                                                <a href="#" className="social-link social-link--wa share__link">
                                                    <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                        <path
                                                            fill-rule="evenodd"
                                                            clip-rule="evenodd"
                                            ...
                                            <li className="share__item">
                                                <a href="#" className="social-link social-link--fb share__link">
                                                    <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                        <path
                                            ...
                                            <li className="share__item">
                                                <a href="#" className="social-link social-link--tw share__link">
                                                    <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                        <path
                                            ...
                                            <li className="share__item">
                                                <a href="#" className="social-link social-link--in share__link">
                                                    <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            <li className="share__item">
                                                <a href="#" className="social-link social-link--p share__link">
                                                    <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            <li className="share__item">
                                                <a href="#" className="social-link social-link--lk share__link">
        ...
        <section className="section related-post">
            <div className="container px-0">
                <div className="related-post__header">
                    <h2 className="text--heading-1">Related Ads</h2>
                ...
                <div className="related-post__slider" id="relatedPostSlider">
                    <div className="related-post__slider-item">
                        <div className="cards cards--one cards--highlight">
                            <a href="ad-details.html" className="cards__img-wrapper">
                                ...
                                <div className="cards__tag">urgent</div>
                            </a>
                            <div className="cards__info">
                                <div className="cards__info-top">
                                    ...
                                    <a href="ad-details.html" className="text--body-3-600 cards__caption-title">Binatone Fan</a>
                                </div>
                                <div className="cards__info-bottom">
                                    ...
                                    <span className="cards__price-title text--body-3-600">#32000 </span>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div className="related-post__slider-item">
                        <div className="cards cards--one">
                            <a href="ad-details.html" className="cards__img-wrapper">
                                <img src="/src/images/view/img-03.png" alt="card-img" className="img-fluid" />
                            </a>
                            <div className="cards__info">
                                <div className="cards__info-top">
                                    <h6 className="text--body-4 cards__category-title">
                                    ...
                                    <a href="ad-details.html" className="text--body-3-600 cards__caption-title">Hp2000</a>
                                </div>
                                <div className="cards__info-bottom">
                                    <h6 className="cards__location text--body-4">
                                        <span className="icon">
                                    ...
                                    <span className="cards__price-title text--body-3-600">#12000.00 </span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="related-post__slider-item">
                        <div className="cards cards--one">
                            <a href="ad-details.html" className="cards__img-wrapper">
                                <img src="/src/images/view/img-08.png" alt="card-img" className="img-fluid" />
                            </a>
                            <div className="cards__info">
                                <div className="cards__info-top">
                                    <h6 className="text--body-4 cards__category-title">
                                    ...
                                    <a href="ad-details.html" className="text--body-3-600 cards__caption-title">Tablet Phone</a>
                                </div>
                                <div className="cards__info-bottom">
                                    <h6 className="cards__location text--body-4">
                                        <span className="icon">
                                    ...
                                    <span className="cards__price-title text--body-3-600">#68000.00 </span>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="cards cards--one">
                            ...
                            <div className="cards__info">
                                <div className="cards__info-top">
                                    ...
                                    <a href="ad-details.html" className="text--body-3-600 cards__caption-title"> School Bag</a>
                                </div>
                                <div className="cards__info-bottom">
                                    <h6 className="cards__location text--body-4">
                                        <span className="icon">
                                    ...
                                    <span className="cards__price-title text--body-3-600">#6000.00 </span>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="cards cards--one">
                            ...
                            <div className="cards__info">
                                <div className="cards__info-top">
                                    ...
                                    <a href="ad-details.html" className="text--body-3-600 cards__caption-title"> Electric Kettle</a>
                                </div>
                                <div className="cards__info-bottom">
                                    <h6 className="cards__location text--body-4">
                                        <span className="icon">
                                    ...
                                    <span className="cards__price-title text--body-3-600">8000.00 </span>
                                </div>
                            </div>
                        </div>
                    </div>
