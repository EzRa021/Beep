  ...
  background: "url('src/images/bg/bg-04.jpg') center center/cover no-repeat" 
            ...
            <div className="container">
                ...
                <ul className="breedcrumb__page">
                    ...
                    <li className="breedcrumb__page-item">
                        <a href="#" className="breedcrumb__page-link text--body-3">My ads</a>
                    </li>
                </ul>
            </div>
        </section>
            ...
            <div className="container">
                <div className="row">
                        ...
                        <div className="dashboard__navigation">
                            <div className="dashboard__navigation-top">
                                <div className="dashboard__user-proifle">
                                    ...
                                    <div className="dashboard__user-info">
                                        <h2 className="name text--body-2-600">Jenny Wilson</h2>
                            ...
                            <div className="dashboard__navigation-bottom">
                                <ul className="dashboard__nav">
                                    ...
                                    <li className="dashboard__nav-item">
                                        <a href="post-ads.html" className="dashboard__nav-link">
                                            <span className="icon">
                                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path
                                    ...
                                    <li className="dashboard__nav-item">
                                        <a href="myad.html" className="dashboard__nav-link active">
                                            <span className="icon">
                                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <li className="dashboard__nav-item">
                                        <a href="favourite-ads.html" className="dashboard__nav-link">
                                            <span className="icon">
                                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path
                                    ...
                                    <li className="dashboard__nav-item">
                                        <a href="message-board.html" className="dashboard__nav-link">
                                            <span className="icon">
                                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path
                                    ...
                                    <li className="dashboard__nav-item">
                                        <a href="plans-billing.html" className="dashboard__nav-link">
                                            <span className="icon">
                                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path
                    ...
                    <div className="col-xl-9">
                        ...
                        <div className="dashboard__myads">
                            <div className="header-top">
                                <div className="header-top-item">
                                    <h6 className="text--body-4-600">
                                        Ads
                                    </h6>
                                </div>
                                <div className="header-top-item">
                            ...
                            <div className="body">
                                <div className="body-item body-item--lg">
                                    <div className="card-edit">
                                        <a href="ad-details.html" className="card-edit__item product-name">
                                            <div className="img">
                                                <img src="/src/images/view/img-01.png" alt="product" />
                                            </div>
                                            <h2 className="text--body-3-600">Canon EOS Rebel SL3 / EOS 250D</h2>
                                        </a>
                                        <div className="card-edit__item product-date">
                                            <span className="text--body-4">Jul 13,2021</span>
                                        </div>
                                        <div className="card-edit__item product-price">
                                            <span className="text--body-4">$250.00</span>
                                        </div>
                                        <div className="card-edit__item product-status">
                                            <div className="tag-status tag-status--active">
                                                ...
                                                <h6 className="text--body-3">Active</h6>
                                            </div>
                                        </div>
                                        <div className="card-edit__item product-action">
                                                    ...
                                                    <ul className="edit-dropdown">
                                                        <li className="edit-dropdown__item">
                                                            <a href="#" className="edit-dropdown__link">
                                                                ...
                                                                <h5 className="text--body-4">View Ads Details</h5>
                                                            </a>
                                                        </li>
                                                        <li className="edit-dropdown__item">
                                                            <a href="#" className="edit-dropdown__link">
                                ...
                                <div className="body-item body-item--lg">
                                    <div className="card-edit">
                                        <a href="ad-details.html" className="card-edit__item product-name">
                                            <div className="img">
                                                <img src="/src/images/view/img-02.png" alt="product" />
                                            </div>
                                            <h2 className="text--body-3-600">Canon EOS Rebel SL3 / EOS 250D</h2>
                                        </a>
                                        <div className="card-edit__item product-date">
                                ...
                                <div className="body-item body-item--lg">
                                    <div className="card-edit">
                                        <a href="ad-details.html" className="card-edit__item product-name">
                                            <div className="img">
                                                <img src="/src/images/view/img-03.png" alt="product" />
                                            </div>
                                            <h2 className="text--body-3-600">Canon EOS Rebel SL3 / EOS 250D</h2>
                                        </a>
                                        <div className="card-edit__item product-date">
                                        ...
                                        <div className="card-edit__item product-status">
                                            <div className="tag-status tag-status--expire">
                                                <span className="icon">
                                                    <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                        <path d="M15.1875 5.0625L7.3125 12.9372L3.375 9" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round" />
                                                    </svg>
                                                </span>
                                                <h6 className="text--body-3">Expire</h6>
                                            </div>
                                        </div>
                                        <div className="card-edit__item product-action">
                                            <a href="#" className="btn">
                                ...
                                <div className="body-item body-item--lg">
                                    <div className="card-edit">
                                        <a href="ad-details.html" className="card-edit__item product-name">
                                            <div className="img">
                                                <img src="/src/images/view/img-04.png" alt="product" />
                                            </div>
                                            <h2 className="text--body-3-600">Canon EOS Rebel SL3 / EOS 250D</h2>
                                        </a>
                                        <div className="card-edit__item product-date">
                                ...
                                <div className="body-item body-item--lg">
                                    <div className="card-edit">
                                        <a href="ad-details.html" className="card-edit__item product-name">
                                            <div className="img">
                                                <img src="/src/images/view/img-05.png" alt="product" />
                                            </div>
                                            <h2 className="text--body-3-600">Canon EOS Rebel SL3 / EOS 250D</h2>
                                        </a>
                                        <div className="card-edit__item product-date">
                                        ...
                                        <div className="card-edit__item product-status">
                                            <div className="tag-status tag-status--expire">
                                                ...
                                                <h6 className="text--body-3">Expired</h6>
                                            </div>
                                        </div>
                                        <div className="card-edit__item product-action">
                                            <a href="#" className="btn">
                                ...
                                <div className="body-item body-item--sm">
                                    <div className="cards cards--one overflow-visible">
                                        ...
                                        <div className="cards__info">
                                            <div className="cards__info-top">
                                                ...
                                                <a href="ad-details.html" className="text--body-3-600 cards__caption-title">Toyota Fielder G HYBRID WXB PE...</a>

                                                <div className="cards__info-status">
                                                    <div className="tag-status tag-status--active">
                                                        <span className="icon">
                                                            <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                <path d="M15.1875 5.0625L7.3125 12.9372L3.375 9" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round" />
                                            ...
                                            <div className="cards__info-bottom">
                                                <span className="cards__price-title text--body-3-600">$360.00 </span>
                                                <ul className="edit">
                                                    <li className="edit-icon">
                                                        <span className="icon-toggle">
                                                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                        ...
                                                        <ul className="edit-dropdown">
                                                            <li className="edit-dropdown__item">
                                                                <a href="#" className="edit-dropdown__link">
                                                                    ...
                                                                    <h5 className="text--body-4">Edit Ads</h5>
                                                                </a>
                                                            </li>
                                                            <li className="edit-dropdown__item">
                                                                <a href="#" className="edit-dropdown__link">
                                ...
                                <div className="body-item body-item--sm">
                                    <div className="cards cards--one overflow-visible">
                                        <a href="ad-details.html" className="cards__img-wrapper">
                                            <img src="/src/images/view/img-05.png" alt="card-img" className="img-fluid" />
                                        </a>
                                        <div className="cards__info">
                                            <div className="cards__info-top">
                                                <h6 className="text--body-4 cards__category-title">
                                ...
                                <div className="body-item body-item--sm">
                                    <div className="cards cards--one overflow-visible">
                                        <a href="ad-details.html" className="cards__img-wrapper">
                                            <img src="/src/images/view/img-06.png" alt="card-img" className="img-fluid" />
                                        </a>
                                        <div className="cards__info">
                                            <div className="cards__info-top">
                                                <h6 className="text--body-4 cards__category-title">
                                ...
                                <div className="body-item body-item--sm">
                                    <div className="cards cards--one overflow-visible">
                                        ...
                                        <div className="cards__info">
                                            ...
                                            <div className="cards__info-bottom">
                                                <span className="cards__price-title text--body-3-600">$360.00 </span>
                                                <a href="#" className="btn btn--fav">
                                                    <span className="icon">
                                                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                            <path
                                                                d="M12 20.25L11.8778 20.4681C11.9537 20.5106 12.0463 20.5106 12.1222 20.4681L12 20.25ZM12 20.25C12.1222 20.4681 12.1222 20.4681 12.1224 20.468L12.1228 20.4678L12.1243 20.4669L12.1298 20.4638L12.1509 20.4519C12.1692 20.4414 12.1962 20.4259 12.2311 20.4055C12.3011 20.3647 12.4032 20.3044 12.5328 20.2255C12.792 20.0678 13.1615 19.8358 13.6045 19.5375C14.49 18.9412 15.6718 18.0786 16.8547 17.014C19.2055 14.8983 21.625 11.9276 21.625 8.62501V8.62497C21.6248 7.44044 21.2144 6.29255 20.4635 5.37645C19.7126 4.46034 18.6676 3.83258 17.5061 3.59989C16.3447 3.36719 15.1385 3.54393 14.0926 4.10006C13.2044 4.57239 12.4783 5.29363 12 6.16991C11.5217 5.29363 10.7956 4.57239 9.90736 4.10005C8.8615 3.54393 7.65532 3.36719 6.49388 3.59989C5.33244 3.83258 4.28743 4.46034 3.53654 5.37645C2.78564 6.29255 2.3752 7.44044 2.375 8.62497V8.62501C2.375 11.9276 4.79451 14.8983 7.14526 17.014C8.32819 18.0786 9.50999 18.9412 10.3955 19.5375C10.8385 19.8358 11.208 20.0678 11.4672 20.2255C11.5968 20.3044 11.6989 20.3647 11.7689 20.4055C11.8038 20.4259 11.8308 20.4414 11.8491 20.4519L11.8702 20.4638L11.8757 20.4669L11.8772 20.4678L11.8776 20.468C11.8778 20.4681 11.8778 20.4681 12 20.25Z"
                                                                fill="#00AAFF"
                                                                stroke="#00AAFF"
                                                                stroke-width="0.5"
                                                                stroke-linecap="round"
