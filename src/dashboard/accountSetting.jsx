  ...
  background: "url('src/images/bg/bg-04.jpg') center center/cover no-repeat" 
        ...
        <div className="container">
            ...
            <ul className="breedcrumb__page">
                ...
                <li className="breedcrumb__page-item">
                    <a href="#" className="breedcrumb__page-link text--body-3">Settings</a>
                </li>
            </ul>
        </div>
    </section>
            ...
            <div className="row">
                    ...
                    <div className="dashboard__navigation">
                        <div className="dashboard__navigation-top">
                            <div className="dashboard__user-proifle">
                                <div className="dashboard__user-img">
                                    <img src="/src/images/users/img-06.png" alt="user-photo" />
                                </div>
                        ...
                        <div className="dashboard__navigation-bottom">
                            <ul className="dashboard__nav">
                                ...
                                <li className="dashboard__nav-item">
                                    <a href="account-setting.html" className="dashboard__nav-link active">
                                        <span className="icon">
                                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path
                ...
                <div className="col-xl-9">
                    <div className="dashboard-setting">
                        {/* <!-- Account Information --> */}
                        <div className="dashboard-setting__box account-information">
                            <h2 className="text--body-2-600">Account Information</h2>
                            <div className="user-info">
                                <div className="img">
                                    <div className="img-wrapper">
                                        <img src="/src/images/users/img-06.png" alt="user-img" />
                                    </div>
                                    <a href="#" classNameName="btn btn--bg">
                                        Choose Image
                                    </a>
                                </div>
                                <div className="email">
                                    <h2 className="text--body-3-600">Email: <span>jenny.wilson@gmail.com</span></h2>
                                </div>
                            </div>
                            <form action="#">
                        ...
                        {/* <!-- change Password --> */}
                        <div className="dashboard-setting__box change-password">
                            <h2 className="text--body-2-600">Change Password</h2>
                            <form action="#">
                                <div className="input-field__group">
                                    <div className="input-field">
                                    ...
                                    <div className="input-field">
                                        ...
                                        <span className="icon icon--eye" onclick="showPassword('npassword',this)">
                                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M1 12C1 12 5 4 12 4C19 4 23 12 23 12C23 12 19 20 12 20C5 20 1 12 1 12Z" stroke="#191F33" stroke-width="1.3" stroke-linecap="round" stroke-linejoin="round"></path>
                                                <path
                                                    d="M12 15C13.6569 15 15 13.6569 15 12C15 10.3431 13.6569 9 12 9C10.3431 9 9 10.3431 9 12C9 13.6569 10.3431 15 12 15Z"
                        ...
                        {/* <!-- Delete Account --> */}
                        <div className="dashboard-setting__box delete-account">
                            <h2 className="text--body-2-600">Delete Account</h2>
                            <p className="delete-account__details text--body-3">
